...
- [Xcode 15+](https://developer.apple.com/xcode) (including Xcode command-line tools)
- [CocoaPods 1.11+](https://cocoapods.org)
- [JDK >= 17](https://www.oracle.com/java/technologies/javase/jdk17-downloads.html)
- [Android Studio Giraffe | Hedgehog](https://developer.android.com/studio)
- **Android SDK & Emulator:**
  - SDK Version: Android 13 (API level 33) or later
  - Build Tools: `33.0.1` or newer
  - NDK: `26.1.10909125` or newer (if using native modules)
- [Flipper](https://fbflipper.com) (Optional for debugging)
- [React Native Debugger](https://github.com/jhen0409/react-native-debugger) (Optional for enhanced debugging)
...
`yarn react-native-bootsplash generate src/assets/bootsplash/bootsplash_logo_original.png \
